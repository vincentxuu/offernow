      ...
      {c.job_count_104 != null && c.job_count_104 > 0 && (
        <div className="mb-6">
          <a
            ...
            className="btn inline-flex items-center gap-2 rounded-lg bg-[var(--accent)] px-4 py-2.5 text-sm font-semibold text-[#1a2e1a] no-underline transition hover:bg-[var(--accent-hover)]"
          >
